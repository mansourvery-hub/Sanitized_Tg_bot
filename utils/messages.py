...
TRANSLATIONS = {
    "en": {
        ...
        "help_user_commands": (
            ...
            f"/verify <link> - Google Gemini One Pro (-{VERIFY_COST} points)\n"
            f"/verify2 <link> - ChatGPT Teacher K-12 (-{VERIFY_COST} points)\n"
            f"/verify3 <link> - Spotify Student (-{VERIFY_COST} points)\n"
            f"/verify4 <link> - Bolt.new Teacher (-{VERIFY_COST} points)\n"
            f"/verify5 <link> - YouTube Student (-{VERIFY_COST} points)\n"
